        ...
        <ScrollView style={{ flex: 1 }} showsVerticalScrollIndicator={false} >
            <View style={{}}>
                <View style={{
                    ...
                    <Image source={require('../res/image/img/iconnumber05.png')} style={{
                        width: Sizes.s140,
                        height: Sizes.s140,
                        resizeMode: 'contain'
                    }} />
            ...
            <View style={{ justifyContent: 'center', alignItems: 'center', marginTop: 20 }}>
                ...
                <TouchableOpacity
                    ...
                    style={{ marginTop:10,flexDirection: "row", justifyContent: 'flex-start', alignItems: 'center', borderBottomColor: "#FA8C16", borderBottomWidth: 2, marginHorizontal: 80, }}>
                    <Image source={require('../res/image/img/iconspeci.png')} style={{ height: 35, width: 35, resizeMode: 'contain' }} />
                    <Text
                        style={{ marginLeft: 15, color: '#BFBFBF' }}>
                        Chuyên ngành
                </Text>
                ...
                <DatetimePicker title ="Năm học (từ)"/>
                <View style={{ justifyContent: 'center', alignItems: 'center', marginTop: 20 }}>
                    {/* <Text style={{ color: 'red' }}>
                    * Vui lòng nhập đầy đủ ngày sinh của bạn
                </Text> */}
                ...
                <DatetimePicker title ="Năm học (đến)"/>
                ...
                <View style={{ flexDirection: "row", justifyContent: 'flex-start', alignItems: 'center', borderBottomColor: "#FA8C16", borderBottomWidth: 2, marginHorizontal: 80 , marginTop:10}}>
                    <Image source={require('../res/image/img/iconshool.png')} style={{  height: 35, width: 35, resizeMode: 'contain' }} />
                    <TextInput
