import React, {
  ...
  const BottomSheetQua = forwardRef((props, ref) => {
    ...
    const renderItems = ({item, index}) => {
      ...
      return (
        <TouchableOpacity
          onPress={() => {
            // props.onPress();
            setSelectItem(item.qualification);
            props.OnChooseQua_id(item.id)
            props.OnChooseQua(item.qualification)
  ...
  export default BottomSheetQua;
  BottomSheetQua.defaultProps = {
