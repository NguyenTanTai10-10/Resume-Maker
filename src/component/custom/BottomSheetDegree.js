import React, {
  ...
  const BottomSheetDegree = forwardRef((props, ref) => {
    ...
    const renderItems = ({item, index}) => {
      ...
      return (
        <TouchableOpacity
          onPress={() => {
            // props.onPress();
            setSelectItem(item.degree);
            props.OnChooseDegree_id(item.id)
            props.OnChooseDegree(item.degree)
  ...
  export default BottomSheetDegree;
  BottomSheetDegree.defaultProps = {
