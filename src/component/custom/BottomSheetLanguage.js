import React, {
  ...
  const BottomSheetLanguage = forwardRef((props, ref) => {
    ...
    const renderItems = ({item, index}) => {
      ...
      return (
        <TouchableOpacity
          onPress={() => {
            // props.onPress();
            setSelectItem(item.language);
            props.OnChooselang_id(item.language_id)
            props.OnChooselang(item.language)
  ...
  BottomSheetLanguage.defaultProps = {
