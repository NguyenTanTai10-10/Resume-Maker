import React, {
  ...
  const BottomSheetLeverSc6 = forwardRef((props, ref) => {
    ...
    const renderItems = ({item, index}) => {
      ...
      return (
        <TouchableOpacity
          onPress={() => {
            // props.onPress();
            setSelectItem(item.level);
            props.OnChooseLever_id(item.level_id)
            props.OnChooseLever(item.level)
  ...
  export default BottomSheetLeverSc6;
  BottomSheetLeverSc6.defaultProps = {
