import React, {
  ...
  const BottomSheetFunc = forwardRef((props, ref) => {
      ...
      return (
        <TouchableOpacity
          onPress={() => {
            ...
            props.OnChooseFunc_id(item.functional_role_id)
            props.OnChooseFunc(item.functional_role)
  ...
  export default BottomSheetFunc;
  BottomSheetFunc.defaultProps = {
