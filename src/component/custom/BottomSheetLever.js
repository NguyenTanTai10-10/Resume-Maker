import React, {
  ...
  const BottomSheetLever = forwardRef((props, ref) => {
    ...
    const renderItems = ({item, index}) => {
      ...
      return (
        <TouchableOpacity
          onPress={() => {
            // props.onPress();
            setSelectItem(item.level_group);
            props.OnChooseLever_id(item.level_group_id)
            props.OnChooseLever(item.level_group)
          ...
          <Text>{item.level_group}</Text>
          {selectItem === item.level_group ? (
            <Image
  ...
  export default BottomSheetLever;
  BottomSheetLever.defaultProps = {
