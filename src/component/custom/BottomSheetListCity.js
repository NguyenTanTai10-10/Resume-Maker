import React, {
  ...
  const BottomSheetListCity = forwardRef((props, ref) => {
      ...
      return (
        ...
        key={item.id}
          onPress={() => {
            ...
            props.OnChooseCity_id(item.id)
            props.OnChooseCity(item)
  ...
  export default BottomSheetListCity;
  BottomSheetListCity.defaultProps = {
