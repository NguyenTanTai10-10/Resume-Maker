...
const EditExpComponent = (props) => {
  ...
  useEffect(() => {
      ...
      setDayPass(`${dataSkill.working_time_month_begin}-${dataSkill.working_time_year_begin}`)
      setDayEnd(`${dataSkill.working_time_month_end}-${dataSkill.working_time_year_end}`)
      setMonthPass(dataSkill.working_time_month_begin)
      setYearPass(dataSkill.working_time_year_begin)
      setMonthEnd(dataSkill.working_time_month_end)
      setYearEnd(dataSkill.working_time_year_end)
      setLever_Name(dataSkill.level)
      setLever_Id(dataSkill.level_id)
      setNowDate(dataSkill.is_now)
      setSkillId(dataSkill.skill_id)
